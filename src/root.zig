...
fn hotp(key: []const u8, counter: u64, hash_alg: type) [20]u8 {
    ...
    const counter_big = std.mem.nativeToBig(u64, counter);
    const counter_input = std.mem.asBytes(&counter_big);

    var buf: [20]u8 = undefined;
    hmac.create(&buf, counter_input, key);
...
test hotp {
    ...
    const hash_0 = hotp(secret, 0, crypto.hash.Sha1);
    ...
    const hash_1 = hotp(secret, 1, crypto.hash.Sha1);
    ...
    const hash_2 = hotp(secret, 2, crypto.hash.Sha1);
    ...
    const hash_3 = hotp(secret, 3, crypto.hash.Sha1);
    ...
    const hash_4 = hotp(secret, 4, crypto.hash.Sha1);
    ...
    const hash_5 = hotp(secret, 5, crypto.hash.Sha1);
    ...
    const hash_6 = hotp(secret, 6, crypto.hash.Sha1);
    ...
    const hash_7 = hotp(secret, 7, crypto.hash.Sha1);
    ...
    const hash_8 = hotp(secret, 8, crypto.hash.Sha1);
    ...
    const hash_9 = hotp(secret, 9, crypto.hash.Sha1);
